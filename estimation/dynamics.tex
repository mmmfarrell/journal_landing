...
Appendix~\ref{apdx:estimation_err_state_derivation}. The Jacobians used for the
filter propagation are found by differentiating the error-state dynamics with
respect to the the error-state and input noise resulting in
\begin{align}
