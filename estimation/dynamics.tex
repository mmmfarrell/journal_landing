...
% \end{pmatrix} \nonumber \\
  ...
  % \left( \bar{\vect{\omega}}_{b/I}^b - \hat{\vect{\beta}}_\omega \right)
  % +
  % \left( \bar{\vect{a}} - \hat{\vect{\beta}}_a \right) + \vect{\eta}_v \nonumber
  % \\
  % \dot{\hat{\vect{\beta}}}_a &= \vect{\eta}_{\beta_a} \nonumber
  % \\
  % \dot{\hat{\vect{\beta}}}_\omega &= \vect{\eta}_{\beta_\omega}, \nonumber
% \end{align}
\begin{align}
  \dot{\vect{p}}_{b/I}^I
  &=
...
are zero-mean Gaussian noise processes for the corresponding states.
...
\begin{equation}
  ...
  % \dot{\hat{\vect{r}}}_{i/g}^g = \vect{0}. \label{eq:landmark_dynamics}
\end{equation}
