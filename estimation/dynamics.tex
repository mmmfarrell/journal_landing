...
\end{align}
% $\vect{\eta}_v$, 
where $\vect{\eta}_{\beta_a}$ and $\vect{\eta}_{\beta_\omega}$ are zero-mean
Guassian noise processes corresponding to thes state dynamics and
...
The continous-time derivative of covariance is given by
