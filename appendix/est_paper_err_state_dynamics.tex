\section{Derivation of Error-State Dynamics for the Error-State Kalman Filter}
\label{apdx:estimation_err_state_derivation}

\subsection{UAV Position}
...
\subsection{Target Vehicle Position}
...
\subsection{Target Vehicle Velocity}
...
\subsection{Target Vehicle Attitude}
...
\subsection{Target Vehicle Angular Rate}
...
\subsection{Visual Feature Vector}
