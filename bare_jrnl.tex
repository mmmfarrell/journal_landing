...
\thanks{Manuscript received December 19, 2019; revised December 26, 2019.
...
\markboth{IEEE/ASME TRANSACTIONS ON MECHATRONICS,~VOL.~XX, NO.~X, DECEMBER~20XX}%
{FARRELL AND MCLAIN: 
IMPROVING STATE ESTIMATION OF A LANDING TARGET VEHICLE
FROM A MULTIROTOR UAV USING
VISUAL FEATURE TRACKING}
...
\begin{IEEEbiographynophoto}{Timothy W. McLain}
Biography text here.
\end{IEEEbiographynophoto}
