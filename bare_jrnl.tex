...
\begin{abstract}
  ...
  estimator uses measurements of visual features that are tracked in the UAV's
  ...
  filter about the relative pose between the UAV and the target vehicle. We show
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{imgs/MF.jpg}}]{Michael
  D. Farrell}
  recently completed the MS degree in mechanical engineering at Brigham Young
  University where he completed the BS degree in 2017. He now works as a member
  of the state estimation team at Shield AI in San Diego, CA, focusing on
  vision-based state estimation in GPS-denied or degraded conditions.
  % received the BS and MS degrees in mechanical engineering from Brigham Young
  % University, Provo, UT, where his research focused on autonomous landing of
  % small UAVs using visual-inertial sensor fusion. He is currently a member of
  % the state estimation team at Shield AI in San Diego, CA.
\end{IEEEbiography}
